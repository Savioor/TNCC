...
public class WarReaction extends Reaction<Tuple3<Integer>> {
    public WarReaction(Tuple3<Integer> reaction, Status status) {
    ...
    @Override
    public Reaction<Tuple3<Integer>> parse(Game game, List<String> data) {
        if (data.size() != 3)
